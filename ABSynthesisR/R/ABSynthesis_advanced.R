...
#'
#' @description ABSynthesis_advanced returns results of each study in the set accounting for the overall effect of all other studies.
...
#' @export
ABSynthesis_advanced <- function(successes_base, base_n, successes_variant, variant_n)
    {
        ...
        path <- paste0(c("https://absynthesis.p.rapidapi.com/individual_experiment_results?", paste0(c(a, b, c, d), collapse = "&")) , collapse = "")
